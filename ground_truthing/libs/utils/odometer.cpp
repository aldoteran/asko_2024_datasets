...
Odometer::ComposeOdometryMsg(const geometry_msgs::TransformStamped &tfm) {
  ...
  odom.pose.covariance[6] = position_covariance_[3];
  odom.pose.covariance[7] = position_covariance_[4];
  odom.pose.covariance[8] = position_covariance_[5];
  odom.pose.covariance[12] = position_covariance_[6];
  odom.pose.covariance[13] = position_covariance_[7];
  odom.pose.covariance[14] = position_covariance_[8];
  odom.pose.covariance[21] = attitude_covariance_[0];
  odom.pose.covariance[22] = attitude_covariance_[1];
  odom.pose.covariance[23] = attitude_covariance_[2];
  odom.pose.covariance[27] = attitude_covariance_[3];
  odom.pose.covariance[28] = attitude_covariance_[4];
  odom.pose.covariance[29] = attitude_covariance_[5];
  ...
  odom.twist.covariance[6] = speed_vessel_frame_covariance_[3];
  odom.twist.covariance[7] = speed_vessel_frame_covariance_[4];
  odom.twist.covariance[8] = speed_vessel_frame_covariance_[5];
  odom.twist.covariance[12] = speed_vessel_frame_covariance_[6];
  odom.twist.covariance[13] = speed_vessel_frame_covariance_[7];
  odom.twist.covariance[14] = speed_vessel_frame_covariance_[8];
  odom.twist.covariance[21] = angular_velocity_covariance_[0];
  odom.twist.covariance[22] = angular_velocity_covariance_[1];
  odom.twist.covariance[23] = angular_velocity_covariance_[2];
  odom.twist.covariance[27] = angular_velocity_covariance_[3];
  odom.twist.covariance[28] = angular_velocity_covariance_[4];
  odom.twist.covariance[29] = angular_velocity_covariance_[5];
